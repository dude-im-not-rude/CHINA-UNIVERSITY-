...
export default function AdminDashboard(){
 ...
 return <div className="admin-app"><main className="admin-dashboard"><header className="admin-head"><div><div className="admin-kicker">PRIVATE CONTROL CENTER</div><h1>ChinaUniTracker</h1><p>Admin preview mode</p></div><div className="admin-actions"><button onClick={load} disabled={loading}>{loading?"Refreshing…":"Refresh"}</button><a href="/">Open public site ↗</a></div></header>
 ...
 <section className="admin-panel"><span className="admin-kicker">REVIEW QUEUE</span><h2>Needs Admin Review</h2><p className="muted">Inspect the source, change fields, save a draft, verify a record and publish it to the public site.</p><div className="review-actions"><a href="/admin/reviews">Open review queue →</a></div></section>
